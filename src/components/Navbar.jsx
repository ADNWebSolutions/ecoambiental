...
function Navbar() {
    return (
        <nav className="flex flex-wrap items-center content-between py-3 px-4 fixed w-screen text-white">
            <div className="container mx-auto sm:px-4 justify-center ">
                <div className="flex justify-between mx-4 ">
                    <a className="pt-1 pb-1 mr-4 text-lg whitespace-no-wrap" href="#">
