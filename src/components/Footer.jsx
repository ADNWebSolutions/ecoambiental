  ...
  return (
    <>
          ...
          <div className='container-footer-2 d-flex flex-sm-column '>
            <div className='icons-container'>
              <a
                ...
                href='https://wa.link/huw2rx'
                target='_blank'
              >
                <img src={wapFooter} alt='' width='30' height='30' />
              </a>
              <a
                className='footer-icons'
                href='https://www.instagram.com/controldeplagas.ecoambiental/?hl=es-la'
                target='_blank'
              >
                <img src={instaFooter} alt='' width='35' height='35' />
              </a>
              <a
                className='footer-icons'
                ...
                target='_blank'
              >
                <img src={facebookFooter} alt='' width='30' height='30' />
              </a>
              <a
                className='footer-icons'
                href='mailto:ecoambientaldesinfecciones@gmail.com'
              >
                <img src={emailFooter} alt='' width='30' height='30' />
              </a>
              <p className='telefono'>
                <img src={telefonoFooter} alt='' width='40' height='40' />
                Tel.: 351 386-0091
              </p>
            </div>
          </div>
      ...
      <div className='container-footer-3 flex px-sm-6 '>
        <p className='mb-0 text-start text-sm-center '>
          Sitio web diseñado y desarrollado por ADN Web Solutions
        </p>
      </div>
    </>
  )
